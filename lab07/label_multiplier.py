...
def label_multiplier(t, val):
    ...
    # recursively?
    # base case: is_leaf, then change the label
...
# !!! Note the difference between linked list and trees!! the sub_linked lists are still linked lists, but the subtrees are in a list.
